...
const verbos_comuns = [
	...
	},
	{
		idioma: 'italiano',
		verbos: [
			'accogliere', 'affrettarsi', 'ammettere', 'apparecchiare', 'colpire', 'commuovere', 'digerire', 'dirigere', 'implicare', 'invadere', 'prevalere', 'rivolgersi', 'svenire', 'toccare', 'tradurre', 'calmarsi', 'compiacere', 'gridare', 'impiegare', 'istruire', 'meritare', 'misurare', 'muovere', 'raggiungere', 'rimproverare', 'ripetere', 'riuscire', 'sospendere', 'spedire', 'tentare', 'avvolgere', 'concedere', 'fingere', 'infliggere', 'lamentarsi', 'mantenere', 'medicare', 'nutrire', 'ottenere', 'persuadere', 'promettere', 'reggere', 'restituire', 'rincrescere',  'sposare', 'abbandonare', 'abbronzare', 'abituarsi', 'afferrare', 'assumere', 'comprare', 'friggere', 'gestire', 'guadagnare', 'piovere', 'ridurre', 'ritenere', 'salvare', 'urlare', 'aggiungere', 'alludere', 'ballare', 'comportarsi', 'coprire', 'descrivere', 'dipendere', 'garantire', 'illudere', 'intendere', 'liquidare', 'pretendere', 'salutare', 'sottrarre', 'variare', 'annoiare', 'correggere', 'eleggere', 'fallire', 'fermarsi', 'firmare', 'includere', 'obbligare', 'omettere', 'pesare', 'produrre', 'rassegnarsi', 'scrivere', 'spargere', 'votare', 'accendere', 'assistere','causare', 'celebrare', 'comporre', 'contenere', 'divertirsi', 'esprimere', 'inquinare', 'lottare', 'negoziare', 'spendere', 'suonare', 'temere', 'udire', 'alzare', 'chiedere', 'depositare', 'difendere', 'impersonare', 'incontrare', 'interrompere', 'legare', 'limitare', 'nuotare', 'occupare', 'rispettare', 'tornare', 'turbare', 'valere', 'ardere', 'bloccare', 'camminare', 'condurre', 'distrarre', 'scomodare', 'lanciare', 'mostrare', 'navigare', 'negare', 'operare', 'predire', 'annegare', 'stendere', 'suggerire', 'dettare', 'funzionare', 'girare', 'giurare', 'gustare', 'lodare', 'mangiare', 'modificare', 'parlare', 'piangere', 'rendere', 'resistere', 'stringere', 'togliere', 'trasferire', 'attribuire', 'buttarsi', 'chiamare', 'convincere', 'cuocere', 'distruggere', 'festeggiare', 'indicare', 'organizzare', 'parere', 'penetrare', 'promuovere', 'qualificare', 'quietarsi', 'ridire', 'supporre', 'uscire', 'abbassare', 'corrispondere', 'fidarsi', 'fuggire', 'imprimere', 'informare', 'insistere', 'intervenire', 'notificare', 'odiare', 'partecipare', 'permettere', 'stabilire', 'zittire', 'accadere', 'cedere', 'costruire', 'esaminare', 'mandare', 'nuocere', 'preferire', 'recitare', 'scoprire', 'seguire', 'singhiozzare', 'sorridere', 'spiegare', 'spingere', 'torcere', 'angolare', 'consumare', 'contraddire', 'definire', 'elevare', 'generare', 'lusingare', 'killerare', 'hackerare', 'xerocopiare', 'wappare', 'wikificare'],
		verbos_em_pt: [
